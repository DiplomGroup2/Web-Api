    ...
    <div class="container-center-horizontal">
      <div class="desktop-2 screen">
        <div class="overlap-group4">
          ...
          <div class="rectangle-12 border-0-4px-black"></div>
          <div class="rectangle-13 border-0-4px-black"></div>
          <div class="rectangle-14 border-0-4px-black"></div>
          ...
          <div class="group-8 border-0-4px-white">
            <div class="overlap-group-container">
              <div class="overlap-group-1">
                <div class="rectangle-14-1 border-0-4px-white"></div>
                <div class="rectangle-15 border-0-4px-white"></div>
                <div class="rectangle-16"></div>
              </div>
              <div class="overlap-group1-1">
                <div class="rectangle-14-2 border-0-4px-white"></div>
                <div class="rectangle-15-1 border-0-4px-white"></div>
              </div>
            </div>
          </div>
          ...
          <div class="place-1 fredoka-normal-white-20px">Register</div>
...
.desktop-2 .group-8 {
  ...
  background: linear-gradient(180deg, rgb(254, 254, 254) 0%, rgb(202.94, 227.44, 255) 94.99%);
  border-radius: 32px;
  display: flex;
  height: 59px;
